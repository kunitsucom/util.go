...
var signTestCases = map[string]struct {
	...
	fmt.Sprintf("success(%s)", jwa.RS256): {
		alg:          jwa.RS256,
		key:          must.One(x509z.ParseRSAPrivateKeyPEM([]byte(testingz.TestRSAPrivateKey2048BitPEM))),
	...
	fmt.Sprintf("failure(%s,rsa.SignPKCS1v15)", jwa.RS256): {
		alg:          jwa.RS256,
		key:          &rsa.PrivateKey{PublicKey: *must.One(x509z.ParseRSAPublicKeyPEM([]byte(testingz.TestRSAPublicKey2048BitPEM))), D: big.NewInt(0), Primes: []*big.Int{big.NewInt(0), big.NewInt(0)}},
		signingInput: "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0",
		sigHandler: func(t *testing.T, signatureEncoded string) { //nolint:thelper
			if actual, expect := signatureEncoded, ""; actual != expect {
				t.Errorf("❌: actual != expect: %v", actual)
	...
	fmt.Sprintf("success(%s)", jwa.ES256): {
		alg:          jwa.ES256,
		key:          must.One(x509z.ParseECDSAPrivateKeyPEM([]byte(testingz.TestECDSAPrivateKey256BitPEM))),
		...
		sigHandler: func(t *testing.T, signatureEncoded string) { //nolint:thelper
			if err := jwa.JWS(jwa.ES256).Verify(must.One(x509z.ParseECDSAPublicKeyPEM([]byte(testingz.TestECDSAPublicKey256BitPEM))), "eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0", signatureEncoded); err != nil {
				t.Errorf("❌: err != nil: %v", err)
			}
		},
		errHandler: func(t *testing.T, err error) { //nolint:thelper
	...
	fmt.Sprintf("success(%s)", jwa.ES384): {
		...
		sigHandler: func(t *testing.T, signatureEncoded string) { //nolint:thelper
			if err := jwa.JWS(jwa.ES384).Verify(must.One(x509z.ParseECDSAPublicKeyPEM([]byte(testingz.TestECDSAPublicKey256BitPEM))), "eyJhbGciOiJFUzM4NCIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0", signatureEncoded); err != nil {
				t.Errorf("❌: err != nil: %v", err)
			}
		},
		errHandler: func(t *testing.T, err error) { //nolint:thelper
	...
	fmt.Sprintf("success(%s)", jwa.ES512): {
		...
		signingInput: "eyJhbGciOiJFUzM4NCIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0",
		sigHandler: func(t *testing.T, signatureEncoded string) { //nolint:thelper
			if err := jwa.JWS(jwa.ES512).Verify(must.One(x509z.ParseECDSAPublicKeyPEM([]byte(testingz.TestECDSAPublicKey256BitPEM))), "eyJhbGciOiJFUzM4NCIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0", signatureEncoded); err != nil {
				t.Errorf("❌: err != nil: %v", err)
			}
		},
		errHandler: func(t *testing.T, err error) { //nolint:thelper
	...
	fmt.Sprintf("success(%s)", jwa.PS256): {
		...
		sigHandler: func(t *testing.T, signatureEncoded string) { //nolint:thelper
			if err := jwa.JWS(jwa.PS256).Verify(must.One(x509z.ParseRSAPublicKeyPEM([]byte(testingz.TestRSAPublicKey2048BitPEM))), "eyJhbGciOiJQUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0", signatureEncoded); err != nil {
				t.Errorf("❌: err != nil: %v", err)
			}
		},
		errHandler: func(t *testing.T, err error) { //nolint:thelper
	...
	fmt.Sprintf("success(%s)", jwa.PS384): {
		...
		sigHandler: func(t *testing.T, signatureEncoded string) { //nolint:thelper
			if err := jwa.JWS(jwa.PS384).Verify(must.One(x509z.ParseRSAPublicKeyPEM([]byte(testingz.TestRSAPublicKey2048BitPEM))), "eyJhbGciOiJQUzM4NCIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0", signatureEncoded); err != nil {
				t.Errorf("❌: err != nil: %v", err)
			}
		},
		errHandler: func(t *testing.T, err error) { //nolint:thelper
	...
	fmt.Sprintf("success(%s)", jwa.PS512): {
		...
		sigHandler: func(t *testing.T, signatureEncoded string) { //nolint:thelper
			if err := jwa.JWS(jwa.PS512).Verify(must.One(x509z.ParseRSAPublicKeyPEM([]byte(testingz.TestRSAPublicKey2048BitPEM))), "eyJhbGciOiJQUzUxMiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0", signatureEncoded); err != nil {
				t.Errorf("❌: err != nil: %v", err)
			}
		},
		errHandler: func(t *testing.T, err error) { //nolint:thelper
