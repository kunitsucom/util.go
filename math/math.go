...
var float64Pow10 = [...]float64{
	...
	1e+300, 1e+301, 1e+302, 1e+303, 1e+304, 1e+305, 1e+306, 1e+307, 1e+308, // max
}
...
func IsPow10Int32(z int32) bool {
	for _, e := range int32Pow10 {
		if z == e {
			return true
		}
	}
...
func IsPow10Int64(z int64) bool {
	for _, e := range int64Pow10 {
		if z == e {
			return true
		}
	}
...
func IsPow10Uint32(z uint32) bool {
	for _, e := range uint32Pow10 {
		if z == e {
			return true
		}
	}
...
func IsPow10Uint64(z uint64) bool {
	for _, e := range uint64Pow10 {
		if z == e {
			return true
		}
	}
